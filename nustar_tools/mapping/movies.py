...
def make_movies(fig_dir, frame_folder_name):
    ...
    for ext in extensions:
        ...
        writer = imageio.get_writer(movie_name, fps=MOVIE_CONFIG['FPS'])#, codec='libx264', quality=10, pixelformat='yuv444p') # or yuvj444p
        for f in png_files:
...
def make_cluster_movie(input_dir, min_frame, max_frame, output_dir='', movie_name_prefix='cluster_movie_'):
    ...
    if png_files:
        ...
        for ext in extensions:
            ...
            # Write the png files to the movie file.
            writer = imageio.get_writer(movie_name, fps=MOVIE_CONFIG['FPS'], mode='I')#, codec='libx264', quality=10, pixelformat='yuv444p') # or yuvj444p
            for f in png_files:
